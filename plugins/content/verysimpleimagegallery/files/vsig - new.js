...
function  change_img(direction, t_ident_b) {
debugger;
var topimg = "topimg" + t_ident_b[2];
var thumb = topimg.getAttribute("data-thumbid");
var nextthumb = document.getElementById('_' + data-thumbid).nextSibling;
...
function switchimg(a, b, identifier, thumbidx) {
//var t_ident = window['vsig_'+identifier][thumbidx];
//var t_ident_b = window['vsig_'+identifier][thumbidx];
var t_ident = a;
var t_ident_b = b;
	...
	//vsig_dom(topimg).setAttribute('data-thumbid',callerid);
}
