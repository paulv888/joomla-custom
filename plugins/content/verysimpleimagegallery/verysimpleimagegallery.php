		  ...
		  $document->setHeadData($headerstuff);
			...
			foreach ($matches[0] as $match) {
				...
				if($noimage) {
					...
					if($_im_align_==0){$vsig_cssadd.=".vsig".$identifier." {margin:0 0 0 auto;padding:0;display:block;width:".$_displaywidth_.";}\n";}
					elseif($_im_align_==1){$vsig_cssadd.=".vsig".$identifier." {margin:auto;display:block;width:".$_displaywidth_.";}\n";}
					elseif($_im_align_==3){$vsig_cssadd.=".vsig".$identifier." {margin:10px;float:left;width:".$_displaywidth_.";}\n";}
					elseif($_im_align_==4){$vsig_cssadd.=".vsig".$identifier." {margin:10px;float:right;width:".$_displayidth_.";}\n";}
					else{$vsig_cssadd.=".vsig".$identifier." {width:".$_displaywidth_.";}\n";}
...
//						$html4.="&nbsp;&nbsp;".$_sets_txt_."<span id='countervsig_".$identifier."' class='vsig_counter'>&nbsp;".$_sets_current_."/".$_sets_number_."</span>&nbsp;&nbsp;";
					...
					$html4.='<ul>';
					$html4.='<li title="Previous Frame"><a onclick="change_img_button(-1, \'vsig_'.$identifier.'\'); return false;" rel="nofollow" href=""><i class="icon-leftarrow"></i></a></li>';
//					$html4.='<li title="Rewind"><a onclick="play_button(-1, 0, \'vsig_'.$identifier.'\'); return false;"  rel="nofollow" href=""><i class="icon-backward-2"></i></a></li>';
					$html4.='<li title="Stop"><a onclick="stop_button(1, \'vsig_'.$identifier.'\'); return false;"  rel="nofollow" href=""><i class="icon-stop"></i></a></li>';
					$html4.='<li title="Play"><a onclick="play_button(1, 0, \'vsig_'.$identifier.'\'); return false;"  rel="nofollow" href=""><i class="icon-play"></i></a></li>';
					$html4.='<li title="Next Frame"><a onclick="change_img_button(1, \'vsig_'.$identifier.'\'); return false;" rel="nofollow" href=""><i class="icon-rightarrow"></i></a></li>';
					$html4.='</ul>';

					$html4.='<ul>';
					$html4.='<li title="Speed 1/2"><a onclick="play_button( 1, -1, \'vsig_'.$identifier.'\'); return false;"  rel="nofollow" href=""><i class="icon-backward"></i></a></li>';
					$html4.='<li title="Speed x2"><a onclick="play_button( 1, 1, \'vsig_'.$identifier.'\'); return false;"  rel="nofollow" href=""><i class="icon-forward"></i></a></li>';
					$html4.='</ul>';
