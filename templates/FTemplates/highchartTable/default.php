...
if ($this->showTitle == 1) : ?>
	<div class="page-header fabrik-list-header">
...
?>
	...
	<table class="highchart_<?php echo $this->table->id;?> hidden <?php echo $this->list->class;?>" id="list_<?php echo $this->table->renderid;?>" <?php echo $this->table->outro;?> style="display:none;">
